...
public class FragmentNavigationDrawer extends DrawerLayout {
    ...
    private void selectItem(int position){
        switch(position) {
            case 1:
                Intent a = new Intent(CalcMenu.this, InterestActivity.class);
                startActivity(a);
                break;

            case 2:
                Intent b = new Intent(MainActivity.this, InterestActivity.class);
                startActivity(b);
                break;
            case 3:
                Intent c = new Intent(MainActivity.this, InterestActivity.class);
                startActivity(c);
                break;
        }
    }*/
        // Create a new fragment and specify based on
        // position
